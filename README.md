...
Compatibility with [Kelrugem's Advanced Effects extension](URL="https://www.fantasygrounds.com/forums/showthread.php?48977-Advanced-3-5e-and-Pathfinder-effects") (and any mod that contains it) is currently limited until it gets a compatibility update (coming soon).
